...
<div id="guild_list">
	...
	<table class="guild_list_table" bguild="1">
		...
		<g:each in="${guilds.sort{it.name}}" var="guild">
			...
			<tr>
				...
				<td>
					<g:remoteLink action="describe" controller="guild" update="[success:'guild_description', failure:'message']" params="[guild:guild.id]">
	...
	<g:if test="${guildCount}">
		<g:if test="${offset > 0}">
			...
			<g:remoteLink action="list" controller="guild" params="[max:max, offset:previousOffset]" update="[success:'guild_list', failure:'message']">
		...
		<g:if test="${offset + max < guildCount }">
			...
			<g:remoteLink action="list" controller="guild" params="[max:max, offset:nextOffset]" update="[success:'guild_list', failure:'message']">
