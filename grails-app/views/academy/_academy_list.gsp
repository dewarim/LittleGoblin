<div id="academy_list">
	...
	<g:if test="${offset > 0}">
		...
		<g:remoteLink action="list" controller="academy" params="[max:max, offset:previousOffset]" update="[success:'academy_list', failure:'message']">
	...
	<g:if test="${offset + max < academyCount }">
		...
		<g:remoteLink action="list" controller="academy" params="[max:max, offset:nextOffset]" update="[success:'academy_list', failure:'message']">
